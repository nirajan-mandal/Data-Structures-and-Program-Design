...
//In-line definition. Our compiler seems to have trouble otherwise.
template<class Type>
...
public:
    void delsmallest();
        //fucntion to delete the smallest info from the list
        //precondition: the function operates on a linked list data type
        //postcondition: deletes (once) the smallest item in the list
                         //decreases the count of the list  by one
    void delall(const Type& Item);
        //fucntion to delete all the occurence of an item from the list
        //precondition: takes a parameter of type Type
        //postcondition: delets the occurence of the Item from the list
                         //decreases the count of the list     
    Type kth_element(const int k);
        //fucntion to
        //precondition: 
        //postcondition:     
    void del_kth_element(const int k);
        //fucntion to delete teh kth element of the list
        //precondition: takes an integer 
        //postcondition: if kth item exists it deletes it
...
void linkedListType<Type>::deleteNode(const Type& deleteItem)
{
	...
	// This was giving ou compiler trouble
	/*
template<class Type>
...
template<class Type>
void linkedListType<Type>::delsmallest()
{
     Type min=first->info;
     nodeType<Type> *p=first->link; //pointer to traverse the list
...
template<class Type>
void linkedListType<Type>::delall(const Type& Item)
{
...
template<class Type>
Type linkedListType<Type>::kth_element(const int k)
{   
    nodeType<Type> *p=first; //pointer to traverse the list
...
template<class Type>
void linkedListType<Type>::del_kth_element(const int k)
{   
    nodeType<Type> *p=first; //pointer to traverse the list
    bool message=true;
    for(int i=1; i<=length(); i++)
     ...
     if(message)
      cout<<"entered k value is out of range\n";        
